...
import { updateCategoryQuery, validateCategoryExistsByIdQuery } from '../../DB/queries.mjs';
...
export const updateCategory = async (req, res) => {
    ...
    try {
        ...
        const [brand] = await connection.execute(validateCategoryExistsByIdQuery, [categoryId]);
        console.log(brand)
        ...
        // Actualizar la marca
        await connection.execute(updateCategoryQuery, [name, categoryId]);
